...
$params=array(
    ...
    array(
        'type' => 'tw_category',
        'size' => 10,
        'heading' => esc_html__( 'Course category', 'waves'),
        'value' => 'course_category',
        'std' => '',
        'admin_label' => true,
        'param_name' => 'cats',
        'description' => esc_html__( 'Select course category.', 'waves'),
    ),
    array(
        'type' => 'tw_number',
        'min' => -1,
...
vc_map(array(
    "name" => esc_html__( "Course carousel", 'waves'),
    "description" => esc_html__( "Display your Latest News with 2 Style.", 'waves' ),
    "base" => "tw_course_carousel",
    "class" => "",
    "icon" => "", // Simply pass url to your icon here
    "category" => 'ThemeWaves',
    "params" => $params,
));
class WPBakeryShortCode_tw_course_carousel extends WPBakeryShortCode{}